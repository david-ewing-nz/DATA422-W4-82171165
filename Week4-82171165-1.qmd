...
# Add a page break after the table to ensure it stays on one page
...
kable(df_missingness,caption = "Missingness") %>%
  kable_styling(full_width = F)

kable(ref_model_tidy, caption = "logistic regression results") %>%
